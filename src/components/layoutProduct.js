    ...
    return (
      <Layout>
          <Helmet
              ...
              meta={[{ name: 'description', content: "Produit Femme"}]}
         ...
         <ProductHeader >
            ...
            <InfoWrapper>
                ...
                <p>{markdownRemark.frontmatter.id}</p>
                <p>{markdownRemark.frontmatter.benefits}</p>
                <h3>LES 3 INGREDIENTS MAJEURS:</h3>
                <IconIngr>
                ...
                {featureProducts.map(({ node }) => {
                    ...
                    return (
                        ...
                        <div style={{width:`10rem`,height:`auto`}} key={node.frontmatter.slug}>
                            ...
                            <Link style={{ boxShadow: 'none' }} to={`/produit/${node.frontmatter.slug}`} >
                                <div>
...
query ProductQuery($slug: String!){
  allMarkdownRemark(limit:3,filter: {fileAbsolutePath: {regex: "\/products/"}}) {
      edges {
          node {
            frontmatter {
                slug
